...
export default function Financialdetails({complaintNo,onBackClick,prebool}) {
        ...
        <div className="department-container">
            ...
            <div className="form-container">
                <form>
                    ...
                    <div className="form-group">
                        <label className='label'><b>I.P Number</b></label>
                        <p>: {details[0].ipno}</p>
                    </div>
                    <div className="form-group">
                        <label className='label'><b>B.O Name </b></label>
                        <p>: {details[0].boname}</p>
                    </div>
                    <div className="form-group">
                        <label className='label'><b>R.O Name </b></label>
                        <p>: {details[0].roname}</p>
                    </div>
                    <div className="form-group">
